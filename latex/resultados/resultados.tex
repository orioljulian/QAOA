...
\label{sec:org6ead641}
\subsubsection{Modificadores paper}
\label{sec:org7e3ae9b}
\lstset{language=Python,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
circuit.rz(coef, q_idx)
circuit.rzz(coef * gamma[p], q_idxs[0], q_idxs[1])
...
\subsection{Provider}
\label{sec:orgdca0da9}
\subsubsection{ibmq\textunderscore lima}
\label{sec:orgf5e902b}
...
\subsection{Runtime}
\label{sec:org0cb134b}
\subsubsection{ibmq\textunderscore lima}
\label{sec:org7564614}
\(\beta\)\textsubscript{0} = 0.5, \(\gamma\)\textsubscript{0} = 0.5
\begin{center}
\begin{tabular}{|r|l|r|}
\hline
...
\label{sec:org0b9a0e1}
\subsubsection{Modificadores del paper}
\label{sec:org05c97c4}
\lstset{language=Python,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
circuit.rz(coef, q_idx)
circuit.rzz(coef * gamma[p], q_idxs[0], q_idxs[1])
