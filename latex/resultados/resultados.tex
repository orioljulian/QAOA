...
\label{sec:orgaf02521}
\(\beta\)\textsubscript{0} = 0.5, \(\gamma\)\textsubscript{0} = 0.5
\begin{center}
\includegraphics[scale=0.4]{./img/primer_provider_manila.png}
\end{center}
\newpage

\subsection{Runtime}
\label{sec:orgd626a95}
\subsubsection{ibmq\textunderscore lima}
\label{sec:org01667dd}
\(\beta\)\textsubscript{0} = 0.5, \(\gamma\)\textsubscript{0} = 0.5
\begin{center}
\begin{tabular}{|r|l|r|}
\hline
...
\begin{center}
\includegraphics[scale=0.4]{./img/primer_runtime_lima.png}
\end{center}
\end{document}