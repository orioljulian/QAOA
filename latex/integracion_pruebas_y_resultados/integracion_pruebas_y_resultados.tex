...
\begin{table}[htbp]
  ...
  \begin{tabular}{|c|r|r|}
    \hline
    \textbf{nº Capas} & \textbf{Estadística máxima (\%)} & \textbf{Estadística global (\%)} \\ \hline
    % TODOOOOOO: Por hacer datos
    p = 1 & 0.6\% & 5.9\% \\ \hline
    p = 2 & 30.7\% & 16.9\% \\ \hline
    p = 3 & ?\% & ?\% \\ \hline
  \end{tabular}
  \caption{Resultados de la ejecución de QAOA del tercer grafo}
\end{table}

% TODOOOOOO: Por hacer comentarios
...
% Si no funciona C-c C-c: BibTeX (compilar Bibtex antes)
