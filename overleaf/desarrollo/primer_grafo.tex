...
\begin{figure}[Circuito {--} shortest path de Urgelles et al. (2022) propio]{fig:4-primer_circuito}{ Circuito obtenido con la implementación de QAOA del TFG ($p=1$) }
  \centering
  \includegraphics[scale=0.33]{circuits/primer/primer-circuit-2gamma-p1.png}
\end{figure}

\begin{figure}[Circuito {--} shortest path de Urgelles et al. (2022) de la fuente]{fig:4-primer_paper_circuito}{ Circuito del artículo\cite{multi-objective_routing_optimization} ($p=1$) }
  \centering
  \includegraphics[scale=0.37]{circuits/paper/paper-circuit.png}
\end{figure}

\begin{figure}[Circuito {--} shortest path de Urgelles et al. (2022) de QAOAAnsatz]{fig:4-primer_QAOAAnsatz_circuito}{ Circuito generado por QAOAAnsatz ($p=1$) }
  \centering
