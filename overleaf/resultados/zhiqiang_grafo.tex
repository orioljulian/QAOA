...
\begin{table}[Resultados QAOA {--} artículo de Fan et al. (2023)]{tab:5-zhiqiang_mod-orig_estadisticas}{Ejecución de QAOA del camino más corto en grafo del artículo\cite{solving_shortest_path_with_qaoa}}
  \centering
  \begin{tabular}{|c|r|r|}
    \hline
...
\begin{table}[Resultados QAOAAnsatz {--} artículo de Fan et al. (2023)]{}{Resultados utilizando \textit{QAOAAnsatz} con el problema del artículo\cite{solving_shortest_path_with_qaoa}}
  \centering
  \begin{tabular}{|c|r|r|}
    \hline
    \textbf{nº Capas} & \textbf{NA/TE} & \textbf{MM/TE} \\ \hline
