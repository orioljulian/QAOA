% TODO: MAIL (Explicar esto): DWave y el Quantum Annealing 
% https://www.youtube.com/watch?v=DPxytTrUhdU
% No se tiene acceso al estado cuántico, pero se puede evolucionar el sistema para llegar al estado solución. Se trata de transformar grafos, el del algoritmo al de la arquitectura del sistema. 
% Quantum anealing en lugar de utilizar el calentamiento de Temperatura clásico utiliza el efecto tunel cuántico
