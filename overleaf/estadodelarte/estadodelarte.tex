...
% TODOO: También explicarlo de la forma de: https://www.youtube.com/watch?v=vs7Om4h1WPY
% TODO: Hablar sobre la resolución de $e^{-i \alpha H}$ de la ecuación de Schrodinger

\subsection{Computación adiabática cuántica}

La computación cuántica adiabática (\textbf{AQC}) es, en contraposición con el enfoque en los circuitos, un paradigma basado en el teorema adiabático.  % TODO: Citar definición del teorema adiabático??
